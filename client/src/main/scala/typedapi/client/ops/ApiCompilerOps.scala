...
abstract class BaseApiOps[El <: HList, In <: HList, D <: HList](compiler: ApiCompiler.Aux[El, In, D]) {
...
trait ApiCompilerOps {
  ...
  implicit class ApiOps0[El <: HList, D <: HList](compiler: ApiCompiler.Aux[El, HNil, D]) {

    def apply[C]()(implicit cm: ClientManager[C]) = new TypedApi.EmptyExecutionHelper[El, D, C](compiler, cm)
  }

  implicit class ApiOps1[El <: HList, D <: HList,  K0, V0](compiler: ApiCompiler.Aux[El, FieldType[K0, V0] :: HNil, D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps2[El <: HList, D <: HList,  K0, V0, K1, V1](compiler: ApiCompiler.Aux[El, In2[K0, V0, K1, V1], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps3[El <: HList, D <: HList,  K0, V0, K1, V1, K2, V2](compiler: ApiCompiler.Aux[El, In3[K0, V0, K1, V1, K2, V2], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps4[El <: HList, D <: HList,  K0, V0, K1, V1, K2, V2, K3, V3](compiler: ApiCompiler.Aux[El, In4[K0, V0, K1, V1, K2, V2, K3, V3], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps5[El <: HList, D <: HList,  K0, V0, K1, V1, K2, V2, K3, V3, K4, V4](compiler: ApiCompiler.Aux[El, In5[K0, V0, K1, V1, K2, V2, K3, V3, K4, V4], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps6[El <: HList, D <: HList,  K0, V0, K1, V1, K2, V2, K3, V3, K4, V4, K5, V5](compiler: ApiCompiler.Aux[El, In6[K0, V0, K1, V1, K2, V2, K3, V3, K4, V4, K5, V5], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps7[El <: HList, D <: HList,  K0, V0, K1, V1, K2, V2, K3, V3, K4, V4, K5, V5, K6, V6](compiler: ApiCompiler.Aux[El, In7[K0, V0, K1, V1, K2, V2, K3, V3, K4, V4, K5, V5, K6, V6], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOps8[El <: HList, D <: HList,  K0, V0, K1, V1, K2, V2, K3, V3, K4, V4, K5, V5, K6, V6, K7, V7](compiler: ApiCompiler.Aux[El, In8[K0, V0, K1, V1, K2, V2, K3, V3, K4, V4, K5, V5, K6, V6, K7, V7], D]) extends BaseApiOps(compiler) {
  ...
  implicit class ApiOpsN[El <: HList, D <: HList,  In <: HList](compiler: ApiCompiler.Aux[El, In, D]) extends BaseApiOps(compiler)
}
